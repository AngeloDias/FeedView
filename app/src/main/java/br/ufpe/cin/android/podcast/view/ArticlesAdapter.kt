...
class ArticlesAdapter(private val articles: MutableList<Article>, var onTitleClicked: OnEpisodeTitleClickListener): RecyclerView.Adapter<ArticlesAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemTitleTxtView.setOnClickListener{
            onTitleClicked.onClick(articles[position])
        }
    }
